...
# start = "28.04.2023"  # с какой даты начинать тянуть котировки
# end = "30.04.2023"  # финальная дата, по которую тянуть котировки
# ########
...
# txt = urlopen(request_site).readlines()  # здесь лежит огромный массив данных, прилетевший с Финама.
...
# tickers = ['AAPL', 'GOOG', 'C']
# yahoo_financials = YahooFinancials(tickers, concurrent=True, max_workers=8, country="RU")
